...
public class TranslateActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		final Button translate = (Button) findViewById(R.id.translate_button_start_translate);
		...
		editTextTranslateResult = (EditText) findViewById(R.id.translate_edit_text_for_translate);
	...
	public class AsyncTaskExample extends AsyncTask<Integer, Void, Void> {
		...
		protected void onPostExecute(Void aVoid) {
			editTextTranslateResult = (EditText) findViewById(R.id.translate_edit_text_for_result);
